...
This specification defines the mobile UI adaptation for the find-replace feature, ensuring mobile users have an optimal experience using sidebar-based interfaces instead of dialogs, while maintaining code reuse through shared business logic hooks.
