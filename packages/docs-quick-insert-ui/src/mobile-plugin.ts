...
const PLUGIN_NAME = 'DOC_QUICK_INSERT_MOBILE_UI_PLUGIN';

@DependentOn(UniverDrawingUIPlugin, UniverDrawingPlugin, UniverDocsDrawingUIPlugin, UniverDocsDrawingPlugin, UniverMobileUIPlugin)
