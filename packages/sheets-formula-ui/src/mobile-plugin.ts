...
import { FormulaMobileUIController } from './controllers/mobile/formula-ui.controller';
...
export class UniverSheetsFormulaMobileUIPlugin extends Plugin {
    ...
    override onRendered(): void {
        ...
        touchDependencies(this._injector, [
            [FormulaMobileUIController], // FormulaProgressBar relies on TriggerCalculationController, but it is necessary to ensure that the formula calculation is done after rendered.
            [FormulaClipboardController],
            [FormulaRenderManagerController],
            [ImageFormulaRenderController],
        ]);
