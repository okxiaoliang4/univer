...
export const MobileCellLinkEdit = () => {
    ...
    return (
        <div className="univer-flex univer-h-full univer-w-full univer-flex-col univer-gap-4">
            {showLabel
                ? (
                    <FormLayout
            ...
            <div className="univer-mt-auto univer-flex univer-flex-row univer-gap-3 univer-py-4">
                <Button
...
MobileCellLinkEdit.componentKey = 'univer.sheet.mobile-cell-link-edit';
