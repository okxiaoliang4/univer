...
import { AddDecimalMenuItem, CurrencySymbolIconMenuItem, FactoryOtherMobileMenuItem, PercentMenuItem, SubtractDecimalMenuItem } from '../menu';
...
export const menuSchema: MenuSchemaType = {
    [RibbonStartGroup.FORMAT]: {
        ...
        [OpenNumfmtPanelOperator.id]: {
            order: 4,
            menuItemFactory: FactoryOtherMobileMenuItem,
        },
    },
};
