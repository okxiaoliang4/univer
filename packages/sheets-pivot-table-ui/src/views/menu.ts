...
export function registerPivotTableComponents(componentManager: ComponentManager): void {
    componentManager.register(CREATE_PIVOT_TABLE_DIALOG, CreatePivotTableDialog);
}
