...
import { CreatePivotTableCommand, RemovePivotTableCommand, UpdatePivotTableFieldsCommand } from '../pivot-table.command';
...
describe('Pivot Table Commands', () => {
    ...
    describe('DeletePivotTableCommand', () => {
        it('should delete a pivot table', async () => {
            ...
            const result = await RemovePivotTableCommand.handler(accessor, params);
