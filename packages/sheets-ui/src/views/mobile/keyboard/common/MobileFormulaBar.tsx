...
export function MobileFormulaBar(props: IProps) {
    ...
    return (
        ...
        >
            <div className="univer-flex univer-h-full univer-w-full univer-overflow-hidden univer-pl-3">
                ...
                <div
                    className={clsx(`
                      univer-flex univer-h-full univer-w-auto univer-cursor-pointer univer-items-center
                      univer-justify-center univer-px-3 univer-text-base
                      hover:univer-bg-gray-100
                      dark:!univer-text-white dark:hover:!univer-bg-gray-700
                    `, {
                        'univer-cursor-not-allowed univer-text-gray-200 dark:!univer-text-gray-700': editDisable || !editState,
                    })}
