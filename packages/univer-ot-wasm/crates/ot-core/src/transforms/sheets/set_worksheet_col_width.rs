...
use crate::mutations::sheets::{
    SetWorksheetColWidthMutation, InsertColMutation, RemoveColMutation,
...
pub fn register_transforms(registry: &mut TransformRegistry) {
    ...
    registry.register_bidirectional_ref(MoveColsMutation::ID, MUTATION_ID, shared::move_cols_shift::<GenericRangesParams>());
