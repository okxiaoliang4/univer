...
impl TransformServiceCore {
    pub fn new() -> Self {
        ...
        service.register_transform::<sheets_mutations::AddConditionalRuleTransform>();
        ...
        service.register_transform::<sheets_mutations::ConditionalFormattingFormulaMarkDirtyTransform>();
        service.register_transform::<sheets_mutations::CopyWorksheetEndTransform>();
        service.register_transform::<sheets_mutations::DeleteConditionalRuleTransform>();
        ...
        service.register_transform::<sheets_mutations::MoveConditionalRuleTransform>();
        ...
        service.register_transform::<sheets_mutations::SetConditionalRuleTransform>();
