use crate::types::{
    ...
    InsertColMutationParams, RemoveRowsMutationParams,
    RemoveColMutationParams, ObjectMatrixPrimitiveType,
    SubUnitParams, Range,
};
...
fn shift_rows_for_remove(cell_value: &mut ObjectMatrixPrimitiveType, remove_start: u32, remove_end: u32) {
